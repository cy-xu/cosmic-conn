...
"""
Implement IRAF zscale algorithm. Source:
...
def zscale(image, nsamples=1000, contrast=0.25, bpmask=None, zmask=None):
    ...
    # For a zero-indexed array, find the median pixel value
    ...
    ngoodpix, zstart, zslope = zsc_fit_line(
        samples, npix, KREJ, ngrow, MAX_ITERATIONS)
